...
M_.block_structure.block(2).equation = [ 2 6 5 7 3 4 1];
M_.block_structure.block(2).variable = [ 7 1 4 2 3 8 6];
M_.block_structure.block(2).is_linear = false;
M_.block_structure.block(2).NNZDerivatives = 18;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [0 0 1 2 3 4 5 0 0 0 ];
M_.block_structure.block(1).g1_sparse_rowval = int32([]);
M_.block_structure.block(1).g1_sparse_colval = int32([]);
M_.block_structure.block(1).g1_sparse_colptr = int32([]);
M_.block_structure.block(2).g1_sparse_rowval = int32([1 3 4 1 2 1 2 3 4 4 1 3 5 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([1 1 1 2 2 3 3 3 3 4 5 5 5 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 4 6 10 11 14 ]);
M_.block_structure.variable_reordered = [ 5 7 1 4 2 3 8 6];
M_.block_structure.equation_reordered = [ 8 2 6 5 7 3 4 1];
...
M_.dynamic_g1_sparse_rowval = int32([8 5 6 6 7 3 4 5 7 3 4 5 3 4 5 8 1 2 6 2 3 4 7 1 1 8 ]);
M_.dynamic_g1_sparse_colval = int32([5 9 9 10 10 11 11 11 11 12 12 12 13 13 13 13 14 14 14 15 15 16 19 22 24 25 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 1 1 2 2 2 2 4 6 10 13 17 20 22 23 23 23 24 24 24 25 25 26 27 ]);
M_.lhs = {
'1/C'; 
'w'; 
'w'; 
