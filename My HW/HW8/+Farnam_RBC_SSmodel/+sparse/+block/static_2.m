...
residual=NaN(7, 1);
  ...
  T(12)=y(6)*T(7)*params(7)*T(10)/(1-params(6))*T(11);
  T(13)=getPowerDeriv(y(4),1-params(3),1);
if nargout > 3
    g1_v = NaN(20, 1);
g1_v(1)=1;
g1_v(2)=1;
g1_v(3)=(-(y(6)*params(7)*T(10)));
g1_v(4)=(-((1-params(3))*y(5)*T(3)*getPowerDeriv(y(4),(-params(3)),1)));
g1_v(5)=(-(T(5)*T(13)));
g1_v(6)=(-(y(5)*T(3)*T(13)));
g1_v(7)=T(12)-(y(8)+1-params(2))*params(1)*T(12);
g1_v(8)=1;
g1_v(9)=(-(T(8)*params(1)));
g1_v(10)=(-(T(4)*(1-params(3))*y(5)*T(9)));
g1_v(11)=(-(T(6)*params(3)*y(5)*getPowerDeriv(y(3),params(3)-1,1)));
g1_v(12)=(-(T(6)*y(5)*T(9)));
...
g1_v(16)=(-1);
g1_v(17)=(-1);
g1_v(18)=(-(params(7)*T(2)));
g1_v(19)=(-1);
g1_v(20)=T(7)*T(11)-(y(8)+1-params(2))*params(1)*T(7)*T(11);
